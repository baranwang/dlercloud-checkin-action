...
const client = new http_client_1.HttpClient('dlercloud-checkin-action');
exports.API = {
    Login: function (email, passwd) {
        return __awaiter(this, void 0, void 0, function* () {
            const { result } = yield client.postJson('https://dler.cloud/api/v1/login', {
                email, passwd
            });
    ...
    Logout: function (access_token) {
        return __awaiter(this, void 0, void 0, function* () {
            yield client.postJson('https://dler.cloud/api/v1/logout', {
                access_token
            });
        });
    },
    Checkin: function (access_token, multiple) {
        return __awaiter(this, void 0, void 0, function* () {
            const { result } = yield client.postJson('https://dler.cloud/api/v1/checkin', {
